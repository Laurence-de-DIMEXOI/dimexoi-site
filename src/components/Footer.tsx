      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-14">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.facebook.com/dimexoi" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center border border-gray-700 text-gray-500 hover:text-off-white hover:border-off-white transition-all" aria-label="Facebook">
              ...
              <a href="https://www.instagram.com/dimexoi" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center border border-gray-700 text-gray-500 hover:text-off-white hover:border-off-white transition-all" aria-label="Instagram">
            ...
            {nlSuccess ? (
              ...
              <form onSubmit={handleNewsletter} className="flex">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-white bg-opacity-5 border border-gray-700 text-off-white text-sm placeholder-gray-600 focus:outline-none focus:border-off-white transition-colors"
                  required
                />
                <button
                  type="submit"
                  disabled={nlLoading}
                  className="bg-off-white text-dark-olive px-6 py-3 font-semibold text-sm uppercase tracking-wider hover:bg-gray-200 transition-colors disabled:opacity-50"
                >
                  {nlLoading ? '...' : 'OK'}
                </button>
              </form>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-600 text-xs gap-4">
          ...
          <div className="flex gap-6">
            <Link href="/mentions-legales" className="hover:text-off-white transition-colors">Mentions légales</Link>
            <Link href="/confidentialite" className="hover:text-off-white transition-colors">Confidentialité</Link>
            <Link href="/cgu" className="hover:text-off-white transition-colors">CGU</Link>
          </div>
        </div>
      </div>
    </footer>
